...
class SemanticSentimentTracker:
    def __init__(self, min_word_len=3, min_sentence_words=2, ignore_words=None, word_threshold=0.72, sent_threshold=0.78):
        self.clusters = []
...
def connect_and_listen(channel, token, ignore_users, min_word_len, min_sentence_words, ignore_words,
                       ignore_mentions, ignore_commands, embed_model_name, word_threshold, sent_threshold):
    ...
    print(f"[INFO] Similarity thresholds - Word: {word_threshold}, Sentence: {sent_threshold}\n")
...
def main():
    ...
    parser.add_argument("--word-threshold", type=float, default=0.72,
                        help="Similarity threshold for word clustering (default: 0.72)")
    parser.add_argument("--sent-threshold", type=float, default=0.78,
                        help="Similarity threshold for sentence clustering (default: 0.78)")
    ...
    connect_and_listen(
        ...
        args.model, args.word_threshold, args.sent_threshold
    )
